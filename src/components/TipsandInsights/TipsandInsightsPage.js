...
import { getAllBanners } from "@/app/api/admin/apiService";

export default function TipsandinsightsPage() {
      ...
      {banners.length === 0 && (
        <div className="text-center py-12 sm:py-16">
          ...
          <p className="text-gray-600 text-sm sm:text-base px-4">
            Check back later for updates on our institutional banners.
          </p>
        </div>
      )}
