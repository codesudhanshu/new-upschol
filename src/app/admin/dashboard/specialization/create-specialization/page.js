...
import { createSpecialization } from '@/app/api/admin/apiService'
import Swal from 'sweetalert2'
import { Loader } from '@/utils/Loader'

const SimpleSpecializationCreatePage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if(result.result.message == "A Specialization with this URL already exists")
      {
        Swal.fire({
          icon: 'error',
          title: 'error!',
      ...
      Swal.fire({
        ...
        text: error.message || 'Failed to create Specialization',
        confirmButtonColor: '#ef4444'
      })
    } finally {
  ...
  return (
    <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-8">
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl shadow-lg p-6 mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Create New Specialization Post</h1>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600 mt-1">
              Start writing your Specialization content here... Click the image button to insert images.
            </div>
          </div>
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  ...
                  <span>Publish Specialization</span>
                </>
              )}
            </button>
...
export default SimpleSpecializationCreatePage