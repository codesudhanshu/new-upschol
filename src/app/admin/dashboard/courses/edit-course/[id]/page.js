...
import { BookOpen, FileText, GraduationCap, Calendar, Save, ArrowLeft } from 'lucide-react';
import Swal from 'sweetalert2';
import { courseCategoryList, getCourseById, updateCourse } from '@/app/api/admin/courseapi';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const categoriesRes = await courseCategoryList();
        ...
        if (courseRes && courseRes.result && courseRes.result.course) {
          const course = courseRes.result.course;
          setFormData({
