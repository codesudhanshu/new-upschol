...
import { Plus, FileText, MessageCircle, Award, GraduationCap, DollarSign, Clock } from 'lucide-react';
import Swal from 'sweetalert2';
import { createjob } from '@/app/api/admin/apiService';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result.status === true && result.error === null) {
        showSuccessAlert('Success!', 'Job has been created successfully.');
        setFormData({ 
          title: '', 
          description: '', 
          experience: '', 
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="mt-1 text-sm text-indigo-700">
                Make sure your Job title is clear and descriptive, and provide a comprehensive answer in the description field.
              </p>
            </div>
          </div>
      </div>
