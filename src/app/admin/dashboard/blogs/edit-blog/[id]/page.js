...
import { getBlogByIds, updateBlog } from '@/app/api/admin/apiService'
...
const EditBlogPage = ({ params }) => {
  ...
  useEffect(() => {
      ...
      try {
        ...
        if (response.status === true) {
          ...
          if (blog) {
            ...
            setExistingBannerImage(blog.bannerImage || '')
            ...
            setErrors({ fetch: 'Blog not found' })
          }
        } else {
          setErrors({ fetch: 'Failed to load blog' })
        }
      } catch (error) {
    ...
    if (id) {
      ...
      setFetching(false)
      setErrors({ fetch: 'No Blog ID provided' })
    }
  }, [id])
  ...
  const validateForm = () => {
    ...
    if (!bannerImage && !existingBannerImage) {
    ...
    if (wordCount > 60) {
      newErrors.description = 'Description should be maximum 60 words'
    }
    ...
    try {
      ...
      if (result.status === true) {
        ...
        Swal.fire({
          icon: 'error',
          title: 'Error!',
          text: result.error || result.message || 'Failed to update blog',
    ...
    <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-8">
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl shadow-lg p-6 mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Edit Blog Post</h1>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-50 text-gray-900 placeholder-gray-400 text-lg font-medium transition-all disabled:bg-gray-100 disabled:cursor-not-allowed ${
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                disabled={isSubmitting}
                className={`flex-1 px-4 py-3 border rounded-r-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-50 text-gray-900 placeholder-gray-400 transition-all disabled:bg-gray-100 disabled:cursor-not-allowed ${
          ...
          <div>
            ...
            <textarea
              ...
              disabled={isSubmitting}
              rows="3"
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-50 text-gray-900 placeholder-gray-400 transition-all disabled:bg-gray-100 disabled:cursor-not-allowed resize-none ${
                errors.description ? 'border-red-500' : 'border-gray-200'
              }`}
            />
            <div className="flex justify-between text-sm mt-1">
              <span className={errors.description ? 'text-red-600' : 'text-gray-600'}>
                {errors.description ? errors.description : 'This will be used as the meta description'}
              </span>
              <span className={description.trim().split(/\s+/).length > 60 ? 'text-red-500' : 'text-gray-600'}>
          ...
          <div>
            ...
            <input
              ...
              disabled={isSubmitting}
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-50 text-gray-900 placeholder-gray-400 transition-all disabled:bg-gray-100 disabled:cursor-not-allowed ${
          ...
          <div>
            ...
            <div className={`border-2 border-dashed rounded-lg p-6 text-center hover:border-indigo-400 transition-colors relative ${
              errors.bannerImage ? 'border-red-300 bg-red-50' : 'border-gray-200'
            }`}>
              <input
                type="file"
                accept="image/*"
                ...
                {bannerImagePreview || existingBannerImage ? (
                  <div className="relative">
                    ...
                    <p className="text-indigo-600 font-medium truncate max-w-xs mx-auto">
                      {bannerImage ? bannerImage.name : 'Current Banner Image'}
                    </p>
                  </div>
                ) : (
                  <>
          ...
          <div>
            ...
            <div
              ...
              className={`min-h-96 p-4 border border-t-0 rounded-b-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white text-gray-900 disabled:bg-gray-100 disabled:cursor-not-allowed ${
            ...
            {errors.content ? (
              ...
              <div className="text-sm text-gray-600 mt-1">
                Edit your blog content here... Click the image button to insert new images.
              </div>
            )}
          </div>
