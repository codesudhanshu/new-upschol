        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          ...
          <section className="py-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#8D0DFE] text-white text-sm font-medium mb-6">
                🎯 Our Purpose
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-[#8D0DFE] mb-4">Mission & Vision</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="group relative bg-gradient-to-br from-white to-gray-50 p-8 rounded-3xl border border-gray-200 hover:border-purple-300 transition-all duration-300 hover:shadow-2xl">
                ...
                <h3 className="text-2xl font-bold text-[#8D0DFE] mb-4">Our Mission</h3>
              ...
              <div className="group relative bg-gradient-to-br from-white to-gray-50 p-8 rounded-3xl border border-gray-200 hover:border-green-300 transition-all duration-300 hover:shadow-2xl">
                ...
                <h3 className="text-2xl font-bold text-[#8D0DFE] mb-4">Our Vision</h3>
                <p className="text-gray-700 leading-relaxed">
          ...
          <section className="py-10 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-[#8D0DFE] mb-6">
                Join Our Educational <span className="bg-gradient-to-r from-purple-600 to-[#8D0DFE] bg-clip-text text-transparent">Revolution</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <button className="group relative bg-gradient-to-r from-[#8D0DFE] to-purple-600 hover:from-purple-600 hover:to-[#8D0DFE] text-white font-bold py-4 px-8 rounded-2xl text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                  <span className="relative z-10">
                    <Link href="/university" className='text-white'>Explore Programs</Link>
                  </span>
                  <div className="absolute inset-0 bg-white/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </button>
                {/* <button className="group flex items-center space-x-2 text-[#8D0DFE] font-semibold py-4 px-8 rounded-2xl border-2 border-[#8D0DFE] hover:bg-[#8D0DFE] hover:text-white transition-all duration-300">
