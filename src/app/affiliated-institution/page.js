import AffiliatedInstitute from "@/components/AffiliatedInstitute/AffiliatedInstitute";
import Layout from "@/components/Candidatepagelayout";
import Image from "next/image";

export default function AffiliatedInstitution() {
  return (
     <Layout>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Discover our officially recognized affiliations and certifications
          </p>
