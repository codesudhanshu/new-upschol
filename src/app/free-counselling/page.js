...
const handleSubmit = async () => {
    ...
    try {
      ...
      // Get university data from localStorage
      ...
      const submitData = {
        ...
        prefferedLearningMethod: formAdditionalData.method || "",
      ...
      if (response.status) {
        ...
        if (result.isConfirmed) {
          ...
          localStorage.removeItem('expertadvice');
          localStorage.removeItem('additionalFormData');
