...
const EducationForm = () => {
  ...
  const SendOTP = () => {
    if (!formData.phone_number || formData.phone_number.length !== 10) {
      setErrors(prev => ({ ...prev, phone_number: 'Please enter valid phone number.' }));
      return;
    }
    setOtpSent(true);
  ...
  const VerifyOTP = () => {
    if (!formData.otp || formData.otp.length !== 6) {
      setErrors(prev => ({ ...prev, otp: 'Please enter valid OTP.' }));
      return;
    }
    setOtpVerified(true);
    setFormData(prev => ({ ...prev, otp_veryfy: formData.otp }));
                ...
                <div className="row uuuuu">
                  <div className="col-lg-6">
                    <div className="form_column countrynumber number_select w-100">
                      ...
                      <input id="enquiry_otp_veryfy" name="otp_veryfy" type="hidden" value={formData.otp_veryfy} />
                      <input id="phoneCustomerEnquiry" className="userphonecode" name="phone_number_with_dial_code" type="hidden" value="" />
                      <input id="stu_dial_codeCustomer_enquiry" className="customer_dial_code" name="dial_code" type="hidden" value="+91" />
                      {errors.phone_number && (
                  ...
                  <div className="col-lg-6">
                    <div className="form_col_12 otpAction">
                      <input
                        ...
                        id="txtotpmobile03"
                        maxLength="6"
                        className="form-control txtotp txtotpmobile03"
                        placeholder="OTP"
                        aria-required="true"
                        style={{ borderRadius: '0' }}
                        name="otp"
                      ...
                      <div className="otpActionBtn">
                        {!otpVerified && otpSent && (
                          <>
                            <input
                              id="enquiryBtnVerifymobile03"
                              className="btnVerify form-control"
                              onClick={VerifyOTP}
                              type="button"
                              value="Verify"
                            />
                            <input
                              id="enquiryBtnResendmobile03"
                              className="btnResend form-control"
                              onClick={ResendCode}
                              type="button"
                              value="Resend"
                            />
                        ...
                        {otpVerified && (
                          <input
                            id="enquiryBtnVerifySuccessmobile03"
                            className="btnVerifySuccess form-control"
                            type="button"
                            value="Verified"
                            style={{ display: 'block' }}
                          />
                      ...
                      {errors.otp && (
                        <span className="error help-inline otp_error_div help-block">
                          <small className="help-block">{errors.otp}</small>
                        </span>
                      )}
                    </div>
                  </div>
